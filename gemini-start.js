...
app.post("/upload", upload.single("file"), async (req, res) => {
  ...
  const promptThing = "give me the name of this object";
  const prompt =
    "How would I build this, put it into steps, and put every step on a new line";
  ...
  try {
    ...
    res.send(`<h1>How to build ${thing}</h1><p>${text}</p>`);
  } catch (error) {
